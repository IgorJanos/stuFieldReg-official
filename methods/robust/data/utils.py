...
"""
    This code is based on the KPSFR source code:
...
def gen_im_partial_grid(mode, frame, f_idx, gt_homo, template, noise_trans, noise_rotate, index):
